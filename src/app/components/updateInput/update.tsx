"use client";
import { Updatevalidationschema } from "@/app/utils/validation/update.validationschema";
...
const Update: React.FC<UpdateProps> = ({ invoiceId, invoiceData, onBack }) => {
  ...
  return (
    ...
    <div className="absolute flex flex-col backdrop-blur-md- md:bg-gray-500 md:bg-opacity-[0.8] w-full overflow-y-scroll   ">
      <div className="flex flex-col w-fit justify-center  bg-white dark:bg-[#141625] md:p-[0] md:w-[616px] lg:ml-[72px]">
        ...
        <form  className="md:overflow-y-auto md:max-h-[150vh] md:px-[6%] scrollbar scrollbar-thumb-purple-600" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col">
            <FieldArray
              ...
              render={(arrayHelpers) => (
                <>
                  {values.items.map(
                    (item: { Qt: number; price: number }, index: number) => (
                      <div
                        key={index}
